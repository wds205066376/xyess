...
public class AdminController {
    ...
    @PostMapping("login")
    public ResultVo login(@RequestBody AdminModel adminModel, HttpSession session) {
        if (adminModel.getAccountNumber() == null || adminModel.getAdminPassword() == null) {
            return ResultVo.fail(ErrorMsg.PARAM_ERROR);
        }

        AdminModel admin = adminService.login(adminModel.getAccountNumber(), adminModel.getAdminPassword());
        if (null == admin) {
